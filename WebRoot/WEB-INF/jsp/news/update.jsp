...
<body>
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form action="${ctx}/news/exUpdate" method="post" class="form-x"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" name="name" value="${obj.name}"
				...
				<div class="form-group">
					...
					<div class="field">
						<script type="text/plain" id="remark_txt_1" name="content" 
							style="width: 100%; height: 300px;">${obj.content}</script>
