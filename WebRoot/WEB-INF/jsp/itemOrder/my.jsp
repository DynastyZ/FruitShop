                ...
                <div class="allGoods width100 hidden_yh hhD" style="display: block;">
                    <c:forEach items="${all}" var="data" varStatus="l">
                        <div class="width100 hidden_yh">
                            ...
                            <c:forEach items="${data.orderDetails}" var="details" varStatus="l">
                            		<div style="width: 838px;border-bottom: 1px dashed #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    <img src="${details.item.url1}" width="100" height="100" class="left_yh" style="padding-right: 10px">
                                    <div class="left_yh" style="width: 580px;">
                                        <h3 class="font18 c_33 font100">${details.item.name}</h3>
                                        <p class="c_66 font16" style="margin-top: 16px;">折扣：${details.item.zk}</p>
                                        <p class="red" style="margin-top: 10px;">￥${details.item.price}</p>
                                    </div>
                                    <div class="right_yh">
                                        <c:if test="${data.status==3}">
                                            <a href="${ctx}/itemOrder/pj?id=${details.itemId}" class="onfff block_yh tcenter font16 onHoverr" style="margin-top: 10px;padding-right: 6px;">
                                                &nbsp;去评价
                                            </a>
                                        </c:if>
                                    </div>
