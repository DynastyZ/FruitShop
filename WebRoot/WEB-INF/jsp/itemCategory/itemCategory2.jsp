		...
		<div class="padding border-bottom">
			<ul class="search" style="padding-left: 10px;">
				<li><a class="button border-main icon-plus-square-o"
					href="${ctx}/itemCategory/add2?pid=${pid}">新增二级类目</a></li>
			</ul>
		</div>
		<table class="table table-hover text-center">
				...
				<tr>
					...
					<td>
						<div class="button-group">
							...
							<a class="button border-red" href="${ctx}/itemCategory/delete2?id=${data.id}">
			...
			<tr>
				<td colspan="8">
					<div class="pagelist">
						<!--分页开始-->
						<pg:pager url="${ctx}/itemCategory/selectBySqlPage2" maxIndexPages="5"
