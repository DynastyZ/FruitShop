...
<body>
	...
	<div class="width1198 center_yh" style="height: 420px;">
		...
		<div class="left_yh" style="width: 486px;height: 420px;margin-left: 42px;">
	        ...
	        <p class="font16 c_66 likeColor" style="margin-top: 20px;">
	            <font style="margin-right: 15px;">数量：</font>
	        ...
	        <div class="buyFor">
	            ...
	            <a href="javascript:void(0)" class="addCar" onclick="addcar(${obj.id})">加入购物车</a>
	        </div>
	        ...
	        <div class="width100 hidden_yh">
	            ...
	            <div id="spPj">
	                <div class="width100 hidden_yh" style="padding-bottom: 20px;border-bottom: 1px dashed #ddd; margin-bottom: 10px;">
	                    <c:forEach items="${obj.pjList}" var="data" varStatus="l">
...
<script type="text/javascript">
	...
	function addcar(itemId) {
		$.ajax({
			type:"post",
			url: "${ctx}/car/exAdd?itemId=" + itemId + "&num=" + tr,
			success(Obj){
				if(Obj.result == 0){
					alert("请登录");
