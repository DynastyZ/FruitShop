		...
		<div class="body-content">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <select name="categoryIdTwo" class="input w50" >
                        <c:forEach items="${categoryList}" var="data" varStatus="l">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <div class="tips"><img alt="${obj.url1}" src="${obj.url1}" width="80px"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="file" class="input w50" name="file" />
                    <div class="tips"><img alt="${obj.url2}" src="${obj.url2}" width="80px"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="file" class="input w50" name="file" />
                    <div class="tips"><img alt="${obj.url3}" src="${obj.url3}" width="80px"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="file" class="input w50" name="file" />
                    <div class="tips"><img alt="${obj.url4}" src="${obj.url4}" width="80px"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="file" class="input w50" name="file" />
                    <div class="tips"><img alt="${obj.url5==null?obj.url5:''}" src="${obj.url5==null?obj.url5:''}" width="80px"></div>
                </div>
            </div>
            <div class="form-group">
